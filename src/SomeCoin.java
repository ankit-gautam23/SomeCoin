...
public class SomeCoin {
    ...
    public static void main(String[] args) {
        ...
        genesisTransaction.outputs.add(new TransactionOutput(genesisTransaction.reciever, genesisTransaction.value, genesisTransaction.transactionId)); //manually add the Transactions Output
